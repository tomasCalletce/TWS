...
def getHandle(arr):
    ...
    if arr[1] == "/page_one":
        ...
        result['response'] = response.encode('utf-8')
        ...
        result['header'] = headers
        result['response'] = headers.encode('utf-8') + image
        ...
        result['header'] = headers
        result['response'] = headers.encode('utf-8') + textFile

    else:
        headers= 'HTTP/1.0 404 Page/File Not Found\n\n'
        result['header'] = headers
        result['response'] = headers.encode('utf-8')
